---
date: 2021-09-09 12:33:03
title: 【常用代码-JS】JS兼容函数
tags:
  - 常用代码
  - 常用代码-JS
---
    ...
    arrEles.forEach(function(ele) {
      ...
      div.setAttribute(
        ...
        "position:absolute;top:" +
          ...
          'px;z-index:9999;font-family:consolas,"Liberation Mono",courier,monospace;font-size:12px;border-radius:2px;color:#fff;background:rgba(0,0,0,.75);opacity:0.8;line-height:13px;padding:0 3px;'
      );
    ...
    doc.addEventListener("keydown", function(event) {
      ...
      arrAcceeekey.forEach(function(accesskey, index) {
        if (
          ...
          (event.keyIdentifier &&
            parseInt(event.keyIdentifier.toLowerCase().replace("u+", ""), 16) ==
